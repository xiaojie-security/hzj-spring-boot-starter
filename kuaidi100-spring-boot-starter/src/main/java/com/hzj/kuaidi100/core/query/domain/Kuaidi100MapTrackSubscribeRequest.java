 ...
 */
@Data
public class Kuaidi100MapTrackSubscribeRequest {
     ...
     * @return 有序参数
     */
    public Map<String, Object> toParameters(String key) {
        Map<String, Object> parameters = new LinkedHashMap<>();
        put(parameters, "company", company);
        ...
        put(subscriptionParameters, "mapConfigKey", mapConfigKey);
